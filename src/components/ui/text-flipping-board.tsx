...
const FlapCell = React.memo(
  function FlapCell({
    ...
    return (
      <div className="flex aspect-[3/6] flex-col overflow-hidden rounded-[2px] border border-black md:rounded-[3px] md:border-2">
        {/* Flap content area */}
        ...
        <div
          className="h-2 w-full bg-[repeating-linear-gradient(to_bottom,currentColor_0,currentColor_1px,transparent_1px,transparent_0.15rem)] text-black md:h-4 md:bg-[repeating-linear-gradient(to_bottom,currentColor_0,currentColor_1px,transparent_1px,transparent_0.2rem)]"
          style={{
